...
nnoremap <Leader>us :Unite -start-insert file<CR>

" Vim compile settings
...
" disable syntastic by default/Use ctrl-w E to check for error
let g:syntastic_mode_map = { 'mode': 'passive', 'active_filetypes': [],'passive_filetypes': [] }
nnoremap <C-w>E :SyntasticCheck<CR> :SyntasticToggleMode<CR>
"}}}

" automatically format using Autoformat plugin once file saved
